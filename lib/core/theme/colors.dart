...
abstract final class MapingoColors {
  // Primary - Mexican Green
  static const Color primary = Color(0xFF00843D);
  ...
  // Map Region Colors
  static const Color regionNorth = Color(0xFF4CAF50);
  static const Color regionCentral = Color(0xFF2196F3);
  static const Color regionWest = Color(0xFFFF9800);
  static const Color regionSouth = Color(0xFF9C27B0);
  static const Color regionSoutheast = Color(0xFFE91E63);
